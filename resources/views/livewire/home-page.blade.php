    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Warung Iqbal</span></h1>
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
              <a href="" class="">
                <img src="https://images.seeklogo.com/logo-png/30/1/vivo-logo-png_seeklogo-305395.png?v=1957936376637184536" alt="" class="object-cover w-full h-64 rounded-t-lg">
              </a>
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
              <a href="" class="">
                <img src="https://www.logo.wine/a/logo/Oppo/Oppo-Logo.wine.svg" alt="" class="object-cover w-full h-64 rounded-t-lg">
              </a>
              <div class="p-5 text-center">
                <a href="" class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-300">
                  OPPO
              ...
              <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                  ...
                  <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                    <div class="flex items-center px-6 mb-2 md:mb-0 ">
                      <div class="flex mr-2 rounded-full">
                        <img src="https://api.duniagames.co.id/api/content/upload/file/16418137651577435521.jpg" alt="" class="object-cover w-12 h-12 rounded-full">
                      </div>
                      <div>
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                  <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                    <div class="flex items-center px-6 mb-2 md:mb-0 ">
                      <div class="flex mr-2 rounded-full">
                        <img src="https://wahyumadyakusuma.wordpress.com/wp-content/uploads/2016/12/download-33.jpg" alt="" class="object-cover w-12 h-12 rounded-full">
                      </div>
                      <div>
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                          Gema Show Indo</h2>
